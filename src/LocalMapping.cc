...
bool LocalMapping::TryInitVIO(void)
{
    ...
    if(!fopened)
    {
        ...
        fcondnum.open("/home/jp/opensourcecode/ORB_SLAM2/tmp/condnum.txt");
        ftime.open("/home/jp/opensourcecode/ORB_SLAM2/tmp/computetime.txt");
...
//            continue;
        ...
        {
            if(fabs(pNextKF->mTimeStamp - pPrevKF->mTimeStamp) > 0.2)
                continue;
        }
